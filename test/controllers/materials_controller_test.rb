...
class MaterialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create material" do
    assert_difference('Material.count') do
      post materials_url, params: { material: { descricao: @material.descricao, nome: @material.nome, qtd: @material.qtd } }
    end
  ...
  test "should update material" do
    patch material_url(@material), params: { material: { descricao: @material.descricao, nome: @material.nome, qtd: @material.qtd } }
