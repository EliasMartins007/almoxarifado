class MaterialsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @material.save
        format.html { redirect_to @material, notice: "Material cadastrado com sucesso." }
  ...
  def destroy
    @material.destroy
    respond_to do |format|
      format.html { redirect_to materials_url, notice: "Material excluido com sucesso." }
  ...
  private
    ...
    def material_params
      params.require(:material).permit(:nome, :qtd, :descricao)
    end
end
